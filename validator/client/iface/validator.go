...
const (
	...
	// RoleUnknown意味着validator的角色不能确定
	...
	// RoleProposer意味着validator应该propose一个block
	RoleProposer
	...
	// RoleSyncCommitteeAggregator意味着validator应该聚合sync committee messages和提交一个sync committee contribution

...
// precompute提供了对于良好结构数据的收集，用于epoch processing，例如attesting records
// 以及balances，对于更快地处理
package precompute
...
// New在每个epoch cycle的开始被处理，返回提前计算的实例，关于validators attesting records
// 以及全部的attested balances，在一个epoch中
